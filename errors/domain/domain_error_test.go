...
func TestErrorsAs(t *testing.T) {
	...
	// Test inheritance using IsDomainError method
	// This is the recommended way to check if an error is a domain error
	assert.True(t, validationErr.IsDomainError(), "ValidationError.IsDomainError() should return true")
	assert.True(t, businessRuleErr.IsDomainError(), "BusinessRuleError.IsDomainError() should return true")
	assert.True(t, notFoundErr.IsDomainError(), "NotFoundError.IsDomainError() should return true")

	// Direct access to the embedded DomainError also works
	assert.NotNil(t, validationErr.DomainError, "ValidationError.DomainError should not be nil")
	assert.NotNil(t, businessRuleErr.DomainError, "BusinessRuleError.DomainError should not be nil")
	assert.NotNil(t, notFoundErr.DomainError, "NotFoundError.DomainError should not be nil")
}
