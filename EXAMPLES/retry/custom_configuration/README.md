# retry custom_configuration Example

## Overview

This example demonstrates the custom_configuration functionality of the ServiceLib retry package.
...
- [error_detection](../error_detection/README.md) - Related example for error_detection
- [logging_tracing](../logging_tracing/README.md) - Related example for logging_tracing
