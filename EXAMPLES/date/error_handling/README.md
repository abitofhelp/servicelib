# date error_handling Example

## Overview

This example demonstrates the error_handling functionality of the ServiceLib date package.
...
- [optional_date](../optional_date/README.md) - Related example for optional_date
- [time_zone](../time_zone/README.md) - Related example for time_zone
