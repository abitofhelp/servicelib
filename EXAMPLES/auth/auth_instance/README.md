# auth auth_instance Example

## Overview

This example demonstrates the auth_instance functionality of the ServiceLib auth package.
...
- [context_utilities](../context_utilities/README.md) - Related example for context_utilities
