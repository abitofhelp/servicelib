# valueobject base_example Example

## Overview

This example demonstrates the base_example functionality of the ServiceLib valueobject package.
...
- [id_example](../id_example/README.md) - Related example for id_example
