# middleware error_handling Example

## Overview

This example demonstrates the error_handling functionality of the ServiceLib middleware package.
...
- [cors](../cors/README.md) - Related example for cors
