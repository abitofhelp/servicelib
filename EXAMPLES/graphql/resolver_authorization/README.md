# graphql resolver_authorization Example

## Overview

This example demonstrates the resolver_authorization functionality of the ServiceLib graphql package.
...
- [auth_configuration](../auth_configuration/README.md) - Related example for auth_configuration
