# model error_handling Example

## Overview

This example demonstrates the error_handling functionality of the ServiceLib model package.
...
- [field_copying](../field_copying/README.md) - Related example for field_copying
